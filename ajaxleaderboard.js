...
function playerfix(){
    ...
    function playerfix4(){
    for (let i4 = 0; i4 < Thursday1fix.length; i4 = i4 +1)
    ...
    function playerfix5(){
    for (let i5 = 0; i5 < Thursday1fix.length; i5 = i5 +1)
    ...
    function playerfix6(){
    for (let i6 = 0; i6 < Thursday1fix.length; i6 = i6 +1)
